...
namespace CoursesAPI.Tests.Services
{
	public class CourseServicesTests
	{
		...
		{
			// Arrange:
			// var emptyList = new List<CourseInstanceDTO>();
			// Assert.Equal(emptyList, _service.GetCourseInstancesBySemester(null));
			// Act:
		...
		[Fact]
		public void GetCoursesBySemester_AllCourses()
		{
				//Arrange
					// 	COURSEID_VEFT_20153
					// COURSEID_VEFT_20163
				...
				//Act
				var courses_20153 = _service.GetCourseInstancesBySemester("20153");
				var courses_20163 = _service.GetCourseInstancesBySemester("20163");

				//Assert
				Assert.Equal(courses_20153[0].CourseInstanceID, COURSEID_VEFT_20153);
				Assert.Equal(courses_20163[0].CourseInstanceID, COURSEID_VEFT_20163);
		}
